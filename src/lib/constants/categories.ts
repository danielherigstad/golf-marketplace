export const CATEGORIES = [
  { id: 1, name: "Drivere", slug: "drivere" },
  { id: 2, name: "Fairwaywood", slug: "fairwaywood" },
  { id: 3, name: "Hybrider", slug: "hybrider" },
  { id: 4, name: "Jernsett", slug: "jernsett" },
  { id: 5, name: "Wedger", slug: "wedger" },
...
// Categories that have hand (right/left) filter
export const CLUB_CATEGORY_SLUGS = [
  "drivere",
  "fairwaywood",
  "hybrider",
  "jernsett",
